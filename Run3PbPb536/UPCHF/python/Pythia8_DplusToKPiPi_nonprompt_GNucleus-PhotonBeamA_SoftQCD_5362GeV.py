# https://github.com/cms-data/GeneratorInterface-EvtGenInterface/blob/master/DECAY_2020_NOLONGLIFE.DEC#L5761
...
DplusDaufilter = cms.EDFilter("PythiaMomDauFilter",
...
ProductionFilterSequence = cms.Sequence(generator*partonfilter*DplusDaufilter)
